<template>
  <div class="edit-goods">
    <el-dialog :title="item.product_id?'编辑产品':'添加产品'" :visible.sync="dialogFormVisible" :center="true" :close-on-click-modal="false" width="50%" @close="closeEdit(false)">
    ...
    closeEdit(flag) {
      if (flag) {
        this.$refs.form.validate(valid => {
          ...
          if (this.item.product_id) {
            this.$http
              .post('/manage/product/edit', this.form)
              .then(res => {
